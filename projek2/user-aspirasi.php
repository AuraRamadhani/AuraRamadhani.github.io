...
if (isset($_POST['cek'])) {
    ...
    if ($result->num_rows > 0) {
      $sql = "INSERT INTO tbaspirasi (id, tanggal, lokasi, jenis_aspirasi, laporan, gambar, nis)
                    VALUES ('$id', '$tanggal', '$lokasi', '$jenis_aspirasi', '$laporan', '$gambar','$nis')";
            $result = mysqli_query($conn, $sql);
            if ($result) {
...
<!--akhir copy -->
    ...
    <div class="mb-3" style="width: 500px;">
      ...
      <input type="number" id="TextInput" name="nis" class="form-control" placeholder="Masukkan NIS" required>
    </div>
